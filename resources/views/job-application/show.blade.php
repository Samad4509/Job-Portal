      ...
      <div class="col-sm-12 col-md-12 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-3">
                <img src="{{ asset('images/user-profile.png') }}" class="img-fluid rounded-circle" alt="User Profile">
              </div>
              <div class="col-9">
                <h6 class="text-info text-capitalize">{{ $applicant->name }}</h6>
                <p class="my-2"><i class="fas fa-envelope"></i> Email: {{ $applicant->email }}</p>
                <a href="{{ asset($application->cv) }}" target="_blank" class="btn btn-primary"><i class="fas fa-file-pdf"></i> View CV</a>
                <br>
                <a href="mailto:{{ $applicant->email }}" class="btn btn-primary mt-2" title="Click to send email"><i class="fas fa-envelope"></i> Send user an email</a>
              </div>
            </div>
          </div>          
        </div>
